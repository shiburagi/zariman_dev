...
class _MeViewState extends State<MeView> with SingleTickerProviderStateMixin {
              ...
              Positioned.fill(
                ...
                child: Card(
                  shape: RoundedRectangleBorder(
                    side: BorderSide(
                      color: Theme.of(context).dividerColor.withAlpha(255),
                      width: 2,
                    ),
                  ),
                  elevation: 10,
  ...
  Widget buildCard(BuildContext context, Me? me) {
    final children = [
      context.isXs
          ? SizedBox()
          : Expanded(flex: 2, child: buildPhoto(context, me)),
      Expanded(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: context.isXs ? 4 : 8),
              Text(me?.location ?? "", style: textStyle),
              SizedBox(height: context.isXs ? 8 : 16),
              StyledText(
                text: me?.summary ?? "",
                tags: {
                  "b": StyledTextTag(
              ...
              SizedBox(height: context.isXs ? 16 : 32),
